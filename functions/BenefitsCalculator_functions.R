...
BenefitsCalculator.Childcare<-function(data, APPLY_CHILDCARE=TRUE,APPLY_HEADSTART=TRUE,APPLY_PREK=TRUE, APPLY_CCDF=TRUE, APPLY_FATES=FALSE, contelig.ccdf = TRUE, contelig.headstart = TRUE, contelig.earlyheadstart = TRUE){
...
data$tax.federal<-data$tax.income.fed+data$tax.FICA # Input into the Federal Tax Credits
...
data$tax.federal_tm12<-data$tax.income.fed_tm12+data$tax.FICA_tm12 # Input into the Federal Tax Credits
