...
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/BenefitsCalculator.OtherBenefits_unittest.rdata"))
rm(data_unittest)
...
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/BenefitsCalculator.Childcare_unittest.rdata"))
rm(data_unittest)
...
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/BenefitsCalculator.Healthcare_unittest.rdata"))
rm(data_unittest)
...
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/BenefitsCalculator.FoodandHousing_unittest.rdata"))
rm(data_unittest)
...
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/BenefitsCalculator.TaxesandTaxCredits_unittest.rdata"))
rm(data_unittest)

# Generate Additional Variables
data<-function.createVars(data)
data_unittest<-data
save (data_unittest,file=paste0(current_directory,"/../unit_test/function.createVars_unittest.rdata"))
rm(data_unittest)
