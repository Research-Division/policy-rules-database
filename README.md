...
* Read [PRD Technical Manual](https://github.com/Research-Division/policy-rules-database/blob/main/PRD%20Technical%20Manual%20-%2007-12-2024.pdf) to get started with the PRD and to learn details about each program included in the database
